...
export function SessionRoute() {
	...
	const { messages, activeToolCalls, thinkingBlocks, runActivity, isStreaming, sendMessage, abort, loadSession } =
		useChat(sessionId ?? null);

	const { files, addFiles, removeFile, clearFiles, uploadFiles, isUploading } = useAttachments();
